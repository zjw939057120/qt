...
Item {
    ...
    // When we manually edit a new color
    // this is the new color proposal
    signal colorModified(color: color)
                    ...
                    ShaderEffect {
                        ...
                        MouseArea {
                            ...
                            function handleMouseMove(x : real, y : real, width : real) : vector2d {
                                ...
                                let color = Qt.hsva(hue, radius, root.color.hsvValue, root.color.a)
